<template>
  ...
  <div class="cart" :class="{ open: showCart }">
    <div>
      ...
      <CartBody :products="products" :reloadCartFunction="reloadCartFunction" />
    </div>
...
export default {
  ...
  setup() {
    ...
    const getProductsCart = async () => {
     const result = await getProductsCartApi();
      if(result){
        products.value = result;
        // console.log("productos en el carrito", result);
